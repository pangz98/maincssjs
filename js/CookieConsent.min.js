(function()
{
	var ckWrap = qSel('#ckWrap'), ckAccept = qSel('#ckAccept');
	 ckWrap.classList.add('v');
	 ckAccept.onclick = ()=>
{
	document.cookie = 'CookiePolicy=Accepted;
	max-age='+PuSet.cookieCon.consentMaxAge+';
	path=/';
	 if (document.cookie) 
{
...
{
	fixedNotif(PuSet.cookieCon.cookieError);
	if('vibrate' in navigator)
{
	navigator.vibrate([100,75,100,75,500])
}
